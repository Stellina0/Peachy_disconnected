-- Copyright by quarty hub!!!!



if game:GetService("CoreGui"):FindFirstChild("PeachyHub") then
    game:GetService("CoreGui"):FindFirstChild("PeachyHub"):Destroy()
end
